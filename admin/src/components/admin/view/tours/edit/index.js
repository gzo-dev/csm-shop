...
const Edit = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (image) {
            ...
            const data = {
                tour_id: self.tour_id, name, status, price, discountPer, desc, departure, departureText, destination, destinationText, content, type, image: "https://api.gzomedia.net/" + imageUrl.file_path
            }
            ...
            const data = {
                tour_id: self.tour_id, name, status, price, discountPer, desc, departure, departureText, destination, destinationText, content, type,
            }
            const result = await apiEditTour({ ...data })
            swal("Thông báo", "Cập nhật thành công", "success")
            .then(()=> history.goBack())
