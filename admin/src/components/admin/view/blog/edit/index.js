...
const Edit = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (image) {
            ...
            const data = {
                id: self.id, name, status, price, discountPer, desc, content, type, image: "https://api.gzomedia.net/" + imageUrl.file_path
            }
            ...
            const data = {
                id: self.id, name, status, price, discountPer, desc, content, type, image: self.photo
            }
            const result = await apiEditBlog({ ...data })
            swal("Thông báo", "Cập nhật thành công", "success")
                .then(() => history.goBack())
