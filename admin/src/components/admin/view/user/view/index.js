  ...
  return (
    <div className="container-fluid">
      ...
      <div className="row">
        <div className="col-6">
          <div className="row">
            <div className="col-lg-4 col-md-4 d-flex align-items-center pl-4" style={{position: "relative"}}>
              <br />
              <input 
                className="inp-mk"
                style={{
              ...
              />
              <IoIosSearch size={24} color={"#fff"} style={{position: "absolute", top: "50%", transform: "translate(0, -50%)", left: "15%"}} />
            </div>
        ...
        <div className="col-6 d-flex flex-row-reverse pr-4 align-items-center">
          ...
          <Button onClick={handleClick} variant="contained" style={{height: 42, borderRadius: 80, background: "#F37335", color: "#fff"}}>
                  ...
                  <table className="table ucp-table table-hover">
                    ...
                    <tbody>
                      {currentItems.map((row, index) => (
                        <tr key={index}>
                          <td>{row.user_id ? row.user_id : "Chưa thiết lập"}</td>
                          <td>{row.firstName} {row.lastName}</td>
                          <td>{row.role}</td>
                          <td>{row.phone ? row.phone : "Chưa thiết lập"}</td>
                          <td>{row.email ? row.email : "Chưa thiết lập"}</td>
                          <th>{row.address ? row.address : "Chưa thiết lập"}</th>
