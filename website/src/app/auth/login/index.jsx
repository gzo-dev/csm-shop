                                            ...
                                            <div className="login-modal-right">
                                                ...
                                                <div className="tab-content">
                                                    <div className="tab-pane active" id="login" role="tabpanel">
                                                        ...
                                                        <fieldset className="form-group">
                                                            <button type="submit" className="btn btn-lg btn-secondary btn-block" onClick={handleSubmit}>Enter to your account</button>
                                                        </fieldset>
                                                        <div className="custom-control custom-checkbox">
                                                            <input type="checkbox" className="custom-control-input" id="customCheck1" checked={rememberMe} onChange={handleRememberMeChange} />
